...
ServerMembership.create!(user_id: a9.id, server_id: s4.id)
ServerMembership.create!(user_id: a10.id, server_id: s4.id)
...
t5 = TextChannel.create!(server_id: s1.id, name: 'code_talk')
